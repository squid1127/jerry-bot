...
class UIService:
    ...
    async def get_channel(
        self, channel_id: int, active: bool = True, ignore_active: bool = False
    ) -> Channel | None:
    ...
    async def set_channel(
        self, channel_id: int, create: bool = False, **kwargs
    ) -> Channel:
    ...
    async def set_guild(
        self, guild_id: int, create: bool = False, **kwargs
    ) -> GuildRecord:
    ...
    async def get_llm_profile(
        self, channel_id: int, profile_id: int
    ) -> LLMProfile | None:
    ...
    async def set_llm_profile(
        self, channel_id: int, id: int | None, create: bool = False, **kwargs
    ) -> LLMProfile:
        ...
        if not profile:
            if not create:
                raise ValueError(
                    f"LLM Profile with ID {id} for channel {channel_id} not found."
                )
