"""Configuration manager for TTS plugin."""
...
class ConfigManager:
    ...
    async def load(self) -> TTSPluginConfig:
        """
        Load the plugin configuration from the YAML file.

        Returns:
            The loaded TTSPluginConfig instance.
        ...
        try:
            async with aiofiles.open(self.config_path, mode="r") as f:
                ...
                self._config = TTSPluginConfig(**config_dict)
    ...
    async def reload(self) -> TTSPluginConfig:
        """
        Reload the configuration from disk.

        Returns:
            The reloaded TTSPluginConfig instance.
        """
    ...
    async def save(self, config: Optional[TTSPluginConfig] = None) -> None:
        ...
        Args:
            config: Optional TTSPluginConfig to save. If None, saves the current config.
